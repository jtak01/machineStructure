...
extern void build_add_test(Seq_T);
extern void build_print_six_test(Seq_T);
extern void build_mul_test(Seq_T);
extern void build_div_test(Seq_T);
extern void build_nand_test(Seq_T);
...
static struct test_info {
        ...
        { "mul", NULL, "", build_mul_test},
        { "div", NULL, "", build_div_test},
